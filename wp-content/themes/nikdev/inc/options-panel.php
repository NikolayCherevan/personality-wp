<?php
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Глобальные блоки ', 'redux-framework-demo' ),
        'id'               => 'basic',
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Титлы ', 'redux-framework-demo' ),
        ...
        'fields'           => array(
            ...
            array(
                'id'        => 'main-hero-title',
                'type'      => 'text',
                'title'     => __( 'hero tiile ', 'redux-framework-demo' ),
                'subtitle'  => __( '', 'redux-framework-demo' ),
                'desc'      => __( 'change hero title ', 'redux-framework-demo' ),
                'default'   => '1',
                'text_hint' => array(
                    'title'   => 'Hint Title',
